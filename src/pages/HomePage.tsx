...
import { Shield, Clock, Award, Star, ArrowRight, Droplets, Wrench, Thermometer, Search, CheckCircle2 } from "lucide-react";
...
export function HomePage() {
  ...
  const services = [
    { title: "Drain Cleaning", desc: "Professional unclogging for kitchens, baths, and main lines.", icon: Search },
    { title: "Pipe Repair", desc: "Emergency leak fixing and full copper/PEX repiping.", icon: Wrench },
    { title: "Water Heaters", desc: "Installation and repair of tanked and tankless systems.", icon: Thermometer },
    { title: "Emergency Dispatch", desc: "24/7 priority service for floods and bursts.", icon: Clock },
  ];
  return (
            ...
            <div className="flex flex-wrap gap-8 pt-8">
              <div className="flex items-center gap-3">
                ...
                <div className="text-sm">
                  ...
                  <p className="font-bold">500+ Google Reviews</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div className="flex flex-col gap-4 w-full md:w-auto">
              <a href="tel:9050000000" className="w-full md:w-auto">
                <Button className="w-full md:w-auto bg-white text-destructive hover:bg-white/90 text-xl font-bold py-8 px-12 rounded-2xl">
                  (905) 555-0123
                </Button>
              </a>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative aspect-square">
               ...
               <GlassCard className="h-full flex items-center justify-center border-white/20 p-12">
